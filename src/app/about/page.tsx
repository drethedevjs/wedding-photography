    ...
    <main>
      ...
      <div className="container mx-auto lg:px-32 md:px-20 px-10 mt-10">
        <p className="text-center mb-10">
          ...
          them with bright and colorful lifestyle portraits. I'm Andre Thomas and 
          I am thrilled that I get to connect with couples and to capture an array 
          of portraits that will allow them to relive a very special day. It is nice 
          to meet you. I look forward to connecting with you to discuss your wedding day, 
          to get to know you, and to share with you all that Covenant LX has to offer.
        </p>
        ...
        <TextTitleBlockMulti heading="Family">
          <>
            Another thing that I want people to know about me is that I love my family: my amazing wife and my two wonderful kids. When I die, I want it said of me that, “if there was one thing that Andre was good at was being a great husband and a loving father.”
          </>
          <>
            It's a beautiful thing when a man commit himself to the woman he loves. Not to romanticize the union–because marriage is hard–but the best things in life aren’t easy.
          </>
          <>
            Weddings are the establishment of families and families are the cornerstone of our society. This is why weddings are meaningful to me.
          </>
        </TextTitleBlockMulti>
