import { ContactCTAProps } from "@/interface/ContactCTAProps";
    ...
    <section className="bg-dark">
      <div className="container mx-auto px-6 md:px-10 py-24 md:py-32 lg:py-40 text-center">
        ...
        <div className="mt-12 md:mt-16">
          <Link
            href={linkTo}
            className="inline-block bg-primary text-white uppercase tracking-[0.35em] text-xs sm:text-sm px-10 md:px-14 py-5 md:py-6 hover:bg-transparent hover:outline-1 hover:outline-primaryDark transition-colors duration-300 ring-0 not-italic font-normal"
          >
            {btnText}
          </Link>
        </div>
